	...
	public class Reporting extends TestListenerAdapter{
		...
		public ExtentTest xTest;
		  ...
		  public void onStart(ITestContext testContext) {
			  ...
			  String replace = "Test-Report-" + DateStamp+".html";
			  htmlReporter = new ExtentHtmlReporter(System.getProperty("user.dir")+"/Reports/"+replace);
			  exReports = new ExtentReports();
			  exReports.attachReporter(htmlReporter);
			  exReports.setSystemInfo("HostName", "localhost");
			  exReports.setSystemInfo("QA", "Kiran");
			  exReports.setSystemInfo("OS", "Windows10t");
